...
const RestaurantCategories = ({ restaurant }: RestaurantCategoriesProps) => {
  const {productsCart, total, toggleIsOpen, totalQuantity} = useContext(CartContext)
    ...
    <div className="relative z-50 mt-[-150px] rounded-3xl bg-white">
        ...
        <ScrollArea className="w-full">
          ...
          {productsCart.length > 0 && (
            <div 
              className="fixed bottom-0 left-0 right-0 flex w-full items-center justify-between border-t bg-white px-4  py-3"
            >
              <div>
